...
class Zn(Element, PeriodIV, GroupXII):
    ...
    def valences_exceptions(self):
        return ((-4, 1), ((1, 'O'), (1, 'O'), (1, 'O'), (1, 'O'), (1, 'O'), (1, 'O')),
                (-2, 1), ((1, 'O'), (1, 'O'), (1, 'O'), (1, 'O')),
                (-2, 1), ((1, 'C'), (1, 'C'), (1, 'C'), (1, 'C')),
                (-1, 1), ((1, 'C'), (1, 'C'), (1, 'C')), (-2, 1), ((1, 'N'), (1, 'N'), (1, 'N'), (1, 'N')),
                (-1, 1), ((1, 'N'), (1, 'N'), (1, 'N')), (-2, 1), ((1, 'S'), (1, 'S'), (1, 'S'), (1, 'S')))
...
class Hg(Element, PeriodVI, GroupXII):
    ...
    @property
    def valences_exceptions(self):
        return ((-2, 1), ((1, 'C'), (1, 'C'), (1, 'C'), (1, 'C')),
                (-1, 1), ((1, 'C'), (1, 'C'), (1, 'C')), (-2, 1), ((1, 'N'), (1, 'N'), (1, 'N'), (1, 'N')),
                (-1, 1), ((1, 'N'), (1, 'N'), (1, 'N')), (-2, 1), ((1, 'S'), (1, 'S'), (1, 'S'), (1, 'S')),
                (0, 2, (1, 'O')), (0, 2, (1, 'Cl')), (0, 2, (1, 'Br')))
    # first lines for complex compounds
    # the last line for Hg(I)
